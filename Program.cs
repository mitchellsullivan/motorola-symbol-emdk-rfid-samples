...
namespace RFID3Sample4
{
    // Salvaged Sample 4 code from Motorola EMDK examples folder.
    // Works in a modern environment.
    ...
    public class Program
    {
        ...
        {
            Program rfidSample = new Program();
            ...
            rfidSample.hostName = "192.168.0.102";
            rfidSample.readerPort = 5084;
